...
where $\bz = \bR^{-1/2} (\by - \mathbf{f})$ and $\bF = \bR^{1/2}\bX$.
  ...
  \end{figure}
	...
	\begin{table}[]
		\centering
		\caption{Results for nonlinear regression problem}
		...
		\begin{tabular}{|l|c|c|c|c|c|}
			...
			\cline{2-6} 
			Prices
			& \multicolumn{1}{c|}{\small{$32.4\pm5.6$}}
			& \multicolumn{1}{c|}{\small{$53.3\pm11.5$}}
			& \multicolumn{1}{c|}{\small{$37.8\pm7.0$}} 
			& \multicolumn{1}{c|}{\small{$28.9\pm13.6$}}
			& \multicolumn{1}{c|}{\small{$\mathbf{24.5\pm9.4}$}}\\ 
			\hline
			Communities
			& \small{$48.0\pm6.4$ }
			& \small{$31.4\pm2.8$}
			...
			\cline{2-6} 
			and Crime 
			& \multicolumn{1}{c|}{\small{$47,5\pm6.5$}}
			& \multicolumn{1}{c|}{\small{$32.9\pm4.3$}}
			& \multicolumn{1}{c|}{\small{$28,1\pm4.5$}} 
			& \multicolumn{1}{c|}{\small{$28.8\pm3.6$}}
			& \multicolumn{1}{c|}{\small{$\mathbf{28.4\pm3.0}$}} \\ 
			\hline
			Forest
			& \small{$18.9\pm0.4$}
			& \small{$1.83\pm0.4$}
			...
			\cline{2-6} 
			Fires
			& \multicolumn{1}{c|}{\small{$\mathbf{20.0\pm2.1}$}}
			& \multicolumn{1}{c|}{\small{$20.2\pm2.2$}}
			& \multicolumn{1}{c|}{\small{$\mathbf{20.0\pm2.0}$}} 
			& \multicolumn{1}{c|}{\small{$20.6\pm1.4$}}
			& \multicolumn{1}{c|}{\small{$20.2\pm2.2$}} \\ 
			\hline
			Residential
			& \small{$51.6\pm17.7$}
			...
			\cline{2-6}
			Building 
			& \multicolumn{1}{c|}{\small{$53.7\pm13.9$}}
			& \multicolumn{1}{c|}{\small{$34.1\pm13.6$}}
			& \multicolumn{1}{c|}{\small{$34.1\pm19.4$}} 
			& \multicolumn{1}{c|}{\small{$35.0\pm15.6$}}
			& \multicolumn{1}{c|}{\small{$\mathbf{30.9\pm5.3}$}} \\ 
			\hline
		\end{tabular}
	\end{table}
	\section*{Conclusion}
